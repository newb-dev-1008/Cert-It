...
for rows in rows_list:
	...
	#im = Image.open("Template8_TBD.png")

	d = ImageDraw.Draw(im)

	paste_bold((810,200) ,(178,34,34), oswald_light, 90 ,rows[1])	

	paste_bold((500,320) ,(178,34,34), oswald_light, 110 ,rows[2])
	...
	paste((810,770) , (178,34,34),oswald_light, 50 , 'On '  + convert_date(rows[7]))
	...
	paste_bold((550, 1005) ,(178,34,34), georgia ,40 , rows[3])
	paste((550, 1075), (0,0,128) , oswald_light , 30 , rows[4])

	paste_bold((1200,1005), (178,34,34) ,georgia , 40 , rows[5])
	paste((1200 , 1075), (0,0,128) , oswald_light , 30 , rows[6])
