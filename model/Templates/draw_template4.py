...
for rows in rows_list:
	...
	#im = Image.open("Template4_TBD.png")

	d = ImageDraw.Draw(im)
	
	paste_bold((810,200) , 	(220,20,60), oswald_light, 90 ,rows[1])	
	...
	paste((380 , 1065), (0,0,128) , oswald_light , 30 , rows[4])

	paste_bold((1300,1025), (102,205,170) ,georgia , 40 , rows[5])
	paste((1300 , 1065), (0,0,128) , oswald_light , 30 , rows[6])

	paste((850 , 1150), (0,0,128) , oswald_light , 35 , rows[8])
